    ...
    <Wrapper className="dressCode">
      ...
      <Content>
        ...
        <List>
          ...
          <ListItem>не забудьте свои медикаменты, если вы их принимаете. И всякие таблетки для пищеварения, если вы дед, и застолья наносят вашему организму сокрушительный удар:)</ListItem>
        </List>
      </Content>
    </Wrapper>
  );
